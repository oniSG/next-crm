                ...
                items: [
                    {
                        ...
                        url: '/advertising-space-arena',
                        icon: <MapIcon />,
                    },
                    {
                        title: 'LED',
                        url: '/advertising-space-led',
                        icon: <ScreenShareIcon />,
                    },
                    {
                        title: 'Arena spaces',
                        url: '/advertising-space-arena-2',
                        icon: <MapPinIcon />,
                    },
                    {
                        title: 'Player',
                        url: '/advertising-space-player',
                        icon: <UserIcon />,
                    },
                    {
                        title: 'Season pass',
                        url: '/advertising-space-card',
                        icon: <CreditCardIcon />,
                    },
                ],
            },
        ...
        items: [
            ...
            },
            {
                ...
                items: [
                    {
                        title: 'Case states',
                        url: '/business-case-state',
                        icon: <CircleDotIcon />,
                    },
                    {
                        title: 'Case types',
                        url: '/business-case-type',
                        icon: <LayersIcon />,
                    },
                    { title: 'Offer states', url: '/offer-state', icon: <BadgeIcon /> },
                    {
                        title: 'Ad space states',
                        url: '/advertising-space-item-state',
