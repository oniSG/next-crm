...
export const REVENUE_CHART_CONFIG = {
  ...
  mobile: { label: "Mobile", color: "var(--chart-3)" }, // rose
...
export const CATEGORY_SHARE = [
  ...
  { name: "Startup", value: 15, fill: "var(--chart-3)" }, // rose
  { name: "Personal", value: 10, fill: "var(--chart-4)" }, // amber
];
...
export const VISITS_CHART_CONFIG = {
  visits: { label: "Visits", color: "var(--chart-2)" }, // blue
  signups: { label: "Signups", color: "var(--chart-4)" }, // amber
} satisfies ChartConfig;
...
export const MRR_CHART_CONFIG = {
  ...
  expansion: { label: "Expansion MRR", color: "var(--chart-4)" }, // amber
} satisfies ChartConfig;
...
export const PERFORMANCE_CHART_CONFIG = {
  team: { label: "Our Team", color: "var(--chart-2)" }, // blue
  target: { label: "Target", color: "var(--chart-3)" }, // rose
} satisfies ChartConfig;
